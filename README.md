This project was bootstrapped with [webpack-dashboard](https://github.com/FormidableLabs/webpack-dashboard) and [Create React App](https://github.com/facebookincubator/create-react-app).
